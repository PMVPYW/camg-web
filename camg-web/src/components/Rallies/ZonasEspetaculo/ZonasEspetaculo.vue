...
function enable_creating (coordinates){
  console.log('changing state',creating.value);

  creating.value = false;
  console.warn(typeof func, 'll');
  creatingObj.value = { coordenadas: coordinates };
  /*
   * creating ref
...
<template>
  ...
  >
    ...
    <div class="m-16">
      <ZonaEspetaculo
          :redraw="redraw_map"
          @createZonaEspetaculo=enable_creating
