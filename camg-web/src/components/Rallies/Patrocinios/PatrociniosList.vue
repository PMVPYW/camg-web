...
<template>
  <div class="h-full rounded-xl transition-all duration-200" id="panel">
    ...
    <CrudButtons :delete_callback="patrocinioStore" :edit_callback="patrocinioStore" :create_callback="patrocinioStore.createPatrocinio" :create_form="CreatePatrocinioForm" :obj_to_edit="selectedPatrocinio"></CrudButtons>
