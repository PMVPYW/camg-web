        ...
        <div class="flex justify-center w-full">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 w-9/12">
            ...
            <div>
              ...
              <h1 v-if="errors.tipocontacto_id" class="text-red-600 text-base font-medium">{{errors.tipocontacto_id[0]}}</h1>
            </div>
            <div>
              ...
              <h1 v-if="errors.tipo_valor" class="text-red-600 text-base font-medium">{{errors.tipo_valor[0]}}</h1>
            </div>
          </div>
        </div>
        <br>
