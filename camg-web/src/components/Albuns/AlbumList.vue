...
<template>
    ...
    <div class="w-11/12 my-8 h-full rounded-lg justify-center mx-auto p-4">
        ...
        <div class="mx-auto h-1/4 w-full p-3 mb-6 sm:flex-none">
            ...
            >
            <select
                class="w-11/12 lg:w-5/12 text-sm h-10 m-2 p-2 text-center border border-gray-300 bg-gray-100 rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
