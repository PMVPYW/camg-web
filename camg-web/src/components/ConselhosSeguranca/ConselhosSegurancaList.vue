...
<template>
  <CrudButtons :obj_to_edit="selected_conselho" :delete_form="SimpleDeleteForm" :create_form="CreateForm" :delete_callback="conselhoSegurancaStore.deleteConselhoSeguranca" :create_callback="conselhoSegurancaStore.createConselhoSeguranca"></CrudButtons>
