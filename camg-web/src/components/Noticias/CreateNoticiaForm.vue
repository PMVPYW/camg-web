      ...
      >
       <div class="mb-2 w-full">
        ...
        <input
          ...
          class="py-3 px-4 block w-full border border-amber-200 focus:border-amber-400 focus:ring-amber-500 bg-gray-100 rounded-lg text-sm file:hidden"
          @change="
       ...
       <div class="w-5/6">
        ...
        <select
          v-model="rally_id"
          class="font-bold py-3 px-4 block w-full border border-amber-200 focus:border-amber-400 focus:ring-amber-500 bg-gray-100 rounded-lg text-sm"
        >
         <option
      ...
      >
       ...
       <div class="flex flex-row">
        ...
        <select
          ...
          class="py-3 px-4 block w-35 border border-amber-200 focus:border-amber-400 focus:ring-amber-500 bg-gray-100 rounded-lg text-sm"
        >
         <option
