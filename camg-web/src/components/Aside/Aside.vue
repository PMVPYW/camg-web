...
<template>
 <div class="flex flex-col">
   ...
   <div class="items-center block w-auto max-h-full overflow-auto h-sidenav grow basis-full">
    <ul class="flex flex-col pl-0 mb-0 h-full">
     <li class="w-full mt-4">
      <h6 class="pl-6 ml-2 my-4 font-bold leading-tight capitalize text-xs opacity-60">Acerca do Clube</h6>
     </li>
     <li class="mt-0.5 w-full" :class="{'drop-shadow-md': $route.name === 'home'}">
      <router-link :to="{ name: 'home' }" :class="{active: $route.name === 'home', 'py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors': $route.name === 'home'}" class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors">
     ...
     <li class="mt-0.5 w-full" :class="{'drop-shadow-md': $route.name === 'diretos'}">
      <router-link :to="{ name: 'diretos' }" :class="{active: $route.name === 'diretos', 'py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors': $route.name === 'diretos'}" class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors">
       <div :class="{'bg-gradient-to-tl from-amber-600 to-yellow-400 shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5 my-1': $route.name === 'diretos', 'shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5 my-1': $route.name !== 'diretos'}">
        <Icon icon="fluent:live-24-regular" class="min-w-5 min-h-5" :class="{'text-white': $route.name === 'diretos'}">
         <title>Diretos</title>
        </Icon>
       </div>
       <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Diretos</span>
      </router-link>
     </li>
     <hr class="h-px my-4 bg-transparent bg-gradient-horizontal-dark">

     <li class="w-full">
      <h6 class="pl-6 ml-2 my-4 font-bold leading-tight capitalize text-xs opacity-60">Acerca dos Rallyes</h6>
     </li>
     ...
     <li class="mt-0.5 w-full" :class="{'drop-shadow-md': $route.name === 'patrociniosOficiais'}">
      <router-link :to="{ name: 'patrociniosOficiais' }" :class="{active: $route.name === 'patrociniosOficiais', 'py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors': $route.name === 'patrociniosOficiais'}" class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors">
       <div :class="{'bg-gradient-to-tl from-amber-600 to-yellow-400 shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5 my-1': $route.name === 'patrociniosOficiais', 'shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5 my-1': $route.name !== 'patrociniosOficiais'}">
        <Icon icon="carbon:chart-relationship" class="min-w-5 min-h-5" :class="{'text-white': $route.name === 'patrociniosOficiais'}">
         <title>Entidades Oficiais</title>
        </Icon>
       </div>
       <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Entidades Oficiais</span>
      </router-link>
     </li>
     ...
     <li class="w-full">
      <h6 class="pl-6 ml-2 my-4 font-bold leading-tight capitalize text-xs opacity-60">Painel de Controlo</h6>
     </li>
     <li class="mt-0.5 w-full mb-4" :class="{'drop-shadow-md': $route.name === 'admins'}">
      <router-link :to="{ name: 'admins' }" :class="{active: $route.name === 'admins', 'py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors': $route.name === 'admins'}" class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors">
       ...
       <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Gerir Administradores</span>
      </router-link>
     </li>
    </ul>
   </div>
  ...
  <aside v-if="button==true" class="sm:hidden min-w-14 max-w-14 bg-white h-full mr-6 ease-nav-brand z-990 inset-y-0 my-4 ml-4 block flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 p-0 shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent text-slate-500">
   <div class="items-center block w-auto max-h-full overflow-auto h-sidenav grow basis-full">
    <ul class="flex flex-col pl-0 mb-0 h-full">
     <li class="mx-auto mt-4">
      <h6 class="my-4 font-bold leading-tight capitalize text-xs opacity-60">Clube</h6>
     </li>
     ...
     <li class="mt-0.5 mx-auto pt-2" :class="{'drop-shadow-md': $route.name === 'diretos'}">
      <router-link :to="{ name: 'diretos' }" :class="{active: $route.name === 'diretos','bg-gradient-to-tl from-amber-600 to-yellow-400 shadow-soft-2xl flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center text-center': $route.name === 'diretos', 'shadow-soft-2xl flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center p-1': $route.name !== 'diretos'}">
       <Icon icon="fluent:live-24-regular" class="min-w-5 min-h-5" :class="{'text-white': $route.name === 'diretos'}">
        <title>Diretos</title>
       </Icon>
      </router-link>
     ...
     <li class="mx-auto">
      <h6 class="my-4 font-bold leading-tight capitalize text-xs opacity-60">Rallyes</h6>
     </li>
     ...
     <li class="mt-0.5 mx-auto" :class="{'drop-shadow-md': $route.name === 'patrociniosOficiais'}">
      <router-link :to="{ name: 'patrociniosOficiais' }" :class="{active: $route.name === 'patrociniosOficiais','bg-gradient-to-tl from-amber-600 to-yellow-400 shadow-soft-2xl flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center text-center': $route.name === 'patrociniosOficiais', 'shadow-soft-2xl flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center p-1': $route.name !== 'patrociniosOficiais'}">
       <Icon icon="carbon:chart-relationship" class="min-w-5 min-h-5" :class="{'text-white': $route.name === 'patrociniosOficiais'}">
        <title>Entidades Oficiais</title>
       </Icon>
      </router-link>
     ...
     <hr class="h-px my-4 bg-transparent bg-gradient-horizontal-dark">
     <li class="mx-auto">
      <h6 class="text-center my-4 font-bold leading-tight capitalize text-xs opacity-60">Painel</h6>
     </li>
