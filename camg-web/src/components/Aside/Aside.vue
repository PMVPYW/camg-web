...
<template>
  <div class="flex flex-col">
    <aside class="sm:flex hidden w-72 h-screen mr-6 ease-nav-brand z-990 inset-y-0 my-4 ml-4 flex-wrap justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 shadow-none transition-transform duration-200 sm:left-1 sm:translate-x-0 sm:bg-transparent text-slate-500">
