    ...
    <div class="items-center block w-auto max-h-full overflow-auto h-sidenav grow basis-full">
      <ul class="flex flex-col pl-0 mb-0 h-full">
        ...
        <li class="mt-0.5 w-full ">
          <router-link :to="{ name: 'home' }" :class="{active: $route.name === 'home'}"  class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="javascript:;">
            <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5 my-1">
        ...
        <li class="mt-0.5 w-full drop-shadow-md">
          <router-link :to="{ name: 'patrocinios' }" :class="{active: $route.name === 'patrocinios'}" class="py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors" href="javascript:;">
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="javascript:;">
            <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current stroke-0 text-center xl:p-2.5 my-1">
            ...
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Galeria</span>
          </a>
        </li>
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="javascript:;">
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="javascript:;">
            ...
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Mapas</span>
          </a>
        </li>
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="javascript:;">
